...
public class Adaption {
	...
	public Adaption(int noBoxes,String adaptionName, boolean initialise, float forgettingfactor) {
		super();
	...
	public double[] processMeasurement(long millis , long distancetravelled, float enginesetting,
			float min, float max){
...
//		
		...
		if(NoOfTimesRoutineHasBeenCalled>7){
			double[] newAdaptors = getParameters2();
