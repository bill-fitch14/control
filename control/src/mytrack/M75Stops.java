...
//			addstop(stop_display1r2);//	
		...
		case "st2f1":
			...
			directionFacing = "Rev";
			//stopNo = "S1F1";
			M76Stop stop_display2f1 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_display2f1.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "S2F1";
			stop_display2f1.set_BG(stopLength, stopStr, stopStr, "Engine");
...
//			addstop(stop_display2f2);
		...
		case "st2r1":
			...
			directionFacing = "Rev";
			//stopNo = "S1";
			M76Stop stop_display2r1 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_display2r1.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "S2R1";
			stop_display2r1.set_BG(stopLength, stopStr, stopStr, "Engine");
...
//			addstop(stop_display2r2);//	
		...
		case "st3f1":
			...
			directionFacing = "Rev";
			//stopNo = "S1F1";
			M76Stop stop_display3f1 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_display3f1.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "S3F1";
			stop_display3f1.set_BG(stopLength, stopStr, stopStr, "Engine");
...
//			addstop(stop_display3f2);
		...
		case "st3r1":
			...
			directionFacing = "Rev";
			//stopNo = "S1";
			M76Stop stop_display3r1 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_display3r1.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "S3R1";
			stop_display3r1.set_BG(stopLength, stopStr, stopStr, "Engine");
...
//			break;
		...
		case "sthr1":
			...
			directionFacing = "Rev";
			//stopNo = "S1";
			M76Stop stop_displayhr1 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_displayhr1.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "SHR1";
			stop_displayhr1.set_BG(stopLength, stopStr, stopStr, "Engine");
		...
		case "sthr2":
			...
			directionFacing = "Rev";
			//stopNo = "S1";
			M76Stop stop_displayhr2 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_displayhr2.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "SHR2";
			stop_displayhr2.set_BG(stopLength, stopStr, stopStr, "Engine");
		...
		case "sthr3":
			...
			directionFacing = "Rev";
			//stopNo = "S1";
			M76Stop stop_displayhr3 = new M76Stop(arc, directionFacing, graph, fraction);
			stop_displayhr3.positionWithinSegment3(0.5f*U4_Constants.scalefactor);
			
			
			stopLength = 0.5f*U4_Constants.scalefactor;
			stopStr = "SHR3";
			stop_displayhr3.set_BG(stopLength, stopStr, stopStr, "Engine");
