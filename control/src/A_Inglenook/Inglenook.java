...
// public static void inglenook2(int N , Long[] init) {
// //initialise the trucks
//
//
// int[] pole = new int[N+1]; // pole[i] = pole (0-2) that disc i is on
//
...
// // Deque<Integer> st1_c = new ArrayDeque<Integer>();
// // Deque<Integer> st2_c = new ArrayDeque<Integer>();
// // Deque<Integer> st3_c = new ArrayDeque<Integer>();
// // Deque<Integer> sth_c = new ArrayDeque<Integer>();
// // try {
// // DeepCopyUtil deepCopyUtil = new DeepCopyUtil();
// // st1_c = deepCopyUtil.deepCopy(st1);
// // st2_c = deepCopyUtil.deepCopy(st2);
// // st3_c = deepCopyUtil.deepCopy(st3);
// // sth_c = deepCopyUtil.deepCopy(sth);
...
//
// Myfunctions.convertLongToStacks(init,pole);
////99//99System.out.print(init);
// Myfunctions.myTransfer1(Myfunctions.getSth(), "sth" ,Myfunctions.getSt1(),
// "st1", Myfunctions.getSth());
////99//99System.out.print(init);
// Myfunctions.drawDiscs();
// // init = Myfunctions.convertStacksToLong(Myfunctions.getSt1(),
// Myfunctions.getSt2(), Myfunctions.getSt3(), Myfunctions.getSth());
// ////99//99System.out.print(init);
// // Myfunctions.convertLongToStacks(init,pole);
// ////99//99System.out.print(init);
// // Myfunctions.drawStacks(pole);
...
// // Myfunctions.convertLongToStacks(init,pole);
//
// Myfunctions.myTransfer1(Myfunctions.getSt3(), "st3", Myfunctions.getSt2(),
// "st2", Myfunctions.getSth());
// // init = Myfunctions.convertStacksToLong(Myfunctions.getSt1(),
// Myfunctions.getSt2(), Myfunctions.getSt3(), Myfunctions.getSth());
// // Myfunctions.convertLongToStacks(init,pole);
// ////99//99System.out.print(init);
...
// Myfunctions.drawDiscs();
//
// Myfunctions.myTransfer1(Myfunctions.getSt3(), "st3", Myfunctions.getSt1(),
// "st1", Myfunctions.getSth());
// Myfunctions.drawDiscs();
//
// // for (int i = N-2; i < pole.length; i++) {
// //
// // pole[i] = 3;
// // }
// //draw(pole);
