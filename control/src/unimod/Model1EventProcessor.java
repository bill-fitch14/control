...
private class A1EventProcessor {
	    ...
	    private static final int set_train_position = 4;
	    private static final int process_points = 5;
	...
	private int decodeState(String state) {
	    ...
	    private static final int e_track_position = 4;
	    private static final int e_process_queue = 5;
	    private static final int e_remove_stop = 6;
	    private static final int e_setTrainPosition = 7;
